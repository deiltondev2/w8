	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `FLW SEU MERDA @${num.split('@')[0]} 😡✋`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD DEILTON BOT*',
			...
			const premium = ["556696159143@s.whatsapp.net","5511985598458@s.whatsapp.net",553189362594"@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","5514997239463@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
        ...
        case 'promover':
				...
				case 'bemvindo':
					...
					if (Number(args[0]) === 1) {
						...
						reply('Ativou com sucesso o recurso de boas-vindas neste grupo️')
					} else if (Number(args[0]) === 0) {
